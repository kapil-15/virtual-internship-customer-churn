...
# installed.
TCL_PREFIX='e:/Project/BCG_X project/EDA/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='e:/Project/BCG_X project/EDA/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='e:/Project/BCG_X project/EDA/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Ie:/Project/BCG_X project/EDA/.conda\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Le:/Project/BCG_X project/EDA/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='e:/Project/BCG_X project/EDA/.conda\Library\lib\tclstub86.lib'
